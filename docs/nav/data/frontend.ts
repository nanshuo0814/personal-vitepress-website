...
export const FRONTEND_DATA: FrontendData[] = [
    ...
    items: [
      {
        ...
        title: 'WebStorm',
        desc: '一款专为前端开发者设计的强大IDE（集成开发环境），由JetBrains公司开发',
        link: 'https://www.jetbrains.com/webstorm/',
      },
      {
        icon: 'https://code.visualstudio.com/favicon.ico',
        title: 'VSCode',
        desc: '全称Visual Studio Code，是由微软开发的一款轻量级且功能强大的代码编辑器',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://hexo.io/icon/apple-touch-icon-57x57.png',
        title: 'Hexo',
        desc: '基于Node.js的静态框架，被广泛用于快速、高效地创建和管理个人博客或网站',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'nginx',
        desc: '一个高性能的HTTP和反向代理web服务器，也可以作为电子邮件代理服务器使用',
